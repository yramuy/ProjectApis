...
$toiData = $dh->excelJobsHndlByTechDwnLoad(1);
// echo "<pre>";
// print_r($toiData['tktdetails']['ticketDetByTypeOfIssue']);

$list = $toiData['tktdetails']['jobsHandledByTechnician'];
// exit();

$object = new PHPExcel();
                    $object->setActiveSheetIndex(0);
                    $heading_columns = array("Reports : Jobs Handled By Technician");
                    $hcolumn = 3;
...
$table_columns = array("S.No","Job Id","Subject","Location","Plant","Department","Functional Location","Equipment");
 ...
 $object_writer = PHPExcel_IOFactory::createWriter($object,'Excel5');
                ...
                header('Content-Disposition: attachment;filename="jobsHandledByTechnician.xls"');
